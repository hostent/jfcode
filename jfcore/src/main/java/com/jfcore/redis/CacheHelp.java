	...
	private static final String SET_WITH_EXPIRE_TIME = "EX";
	 ...
	 {		 
		 ...
		 for (String key : map.keySet()) {
			 ...
			 String result =jedis.set(key, map.get(key), SET_IF_NOT_EXIST, SET_WITH_EXPIRE_TIME, expireSecond);
	 ...
	 {
		 Jedis jedis =  RedisUtil.getJedis();		 
		 String result =jedis.set(key, val, SET_IF_NOT_EXIST, SET_WITH_EXPIRE_TIME, expireSecond);
		 jedis.close();
